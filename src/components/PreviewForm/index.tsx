...
import { INPUT_TYPE } from '../../views/integratedConfiguration/formConfiguration/formConfigurationAdd/typings'
                    ...
                    props.formItemProps.map((itemProps: any, index: number) => (
                        <div className="form_item" key={index} style={
                            ...
                            <div className={itemProps.item_submit_type === 'upload' ? 'form_item_area_pic' : 'form_item_area'}>
                                ...
                                <div className="form_item_desc">{itemProps.item_description}</div>
                            </div>
                                    ...
                                    (() => {
                                        ...
                                        switch (itemProps.item_submit_type) {
                                            case INPUT_TYPE.INPUT:
                                                return <Input value={itemProps.data || null} readOnly />
                                            case INPUT_TYPE.SELECT:
                                                return (
                                                    <Select style={{ width: '100%' }} value={itemProps.data || null}>
                                                        {
                                            ...
                                            case INPUT_TYPE.UPLOAD:
                                                return (
                                                    <Image
                                                        width={150}
                                                        height={150}
                                                        src={itemProps.data ? itemProps.data[0] : "error"}
                                            ...
                                            case INPUT_TYPE.CHECK:
                                                return (
                                                    <Switch checkedChildren="是" unCheckedChildren="否" defaultChecked checked={itemProps.data || false} />
                                                )
                                        }
                                    })()
                                }
